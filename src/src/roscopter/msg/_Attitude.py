...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6f().pack(_x.roll, _x.pitch, _x.yaw, _x.rollspeed, _x.pitchspeed, _x.yawspeed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll, _x.pitch, _x.yaw, _x.rollspeed, _x.pitchspeed, _x.yawspeed,) = _get_struct_6f().unpack(str[start:end])
      return self
